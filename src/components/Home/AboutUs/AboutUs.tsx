    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <section className="py-16 bg-white">
        <div className=" mx-auto px-4">
          <div className="mx-auto bg-gradient-to-r from-blue-50 to-teal-50 rounded-3xl shadow-xl p-8 md:p-12">
            <div className="flex flex-col md:flex-row items-center gap-8">
              <div className="md:w-1/3">
                <div className="relative">
                  <div className="w-64 h-64 rounded-full overflow-hidden border-8 border-white shadow-lg mx-auto">
                    <Image
      ...
      <section className="py-16 bg-gradient-to-br from-gray-900 to-blue-900 text-white">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              <div className="text-5xl font-bold mb-2">২৮+</div>
              <div className="text-xl">সফল বছর</div>
            </div>
            <div>
              <div className="text-5xl font-bold mb-2">২০০০+</div>
              <div className="text-xl">বর্তমান শিক্ষার্থী</div>
            </div>
            <div>
              <div className="text-5xl font-bold mb-2">১২৫+</div>
              <div className="text-xl">প্রশিক্ষিত শিক্ষক</div>
            </div>
            <div>
              <div className="text-5xl font-bold mb-2">৯৮%</div>
              <div className="text-xl">পাশের হার</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="bg-gradient-to-br from-teal-50 to-white p-8 rounded-3xl shadow-lg">
              <div className="flex items-center gap-3 mb-6">
      ...
      <section className="py-16 bg-gradient-to-br from-gray-900 to-blue-900 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-white text-blue-600 px-8 py-3 rounded-full font-bold text-lg hover:bg-blue-50 transition-colors duration-300 shadow-lg">
              ভর্তি প্রক্রিয়া জানুন
            </button>
            <button className="bg-transparent border-2 border-white text-white px-8 py-3 rounded-full font-bold text-lg hover:bg-white hover:text-blue-600 transition-colors duration-300">
