    ...
    <div className="min-h-screen bg-gray-50 p-4 sm:p-6">
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center space-x-2 sm:space-x-4">
            ...
            <div className="relative">
              ...
              {/* Mobile Search Input */}
              {isSearchOpen && (
                <div className="md:hidden absolute top-12 right-0 z-10 bg-white p-2 rounded-lg shadow-lg border border-gray-200 min-w-[200px]">
                  <div className="relative">
              ...
              {quickActions.map((action, index) => {
                ...
                return (
                  <Link
                    href={action.link}
                    key={index}
                    className={`w-full flex items-center space-x-2 sm:space-x-3 p-2 sm:p-3 rounded-lg ${action.color} hover:opacity-90 transition-opacity text-sm sm:text-base`}
                  >
      ...
      <div className="mt-6 sm:mt-8 bg-yellow-50 border border-yellow-200 rounded-xl p-4 sm:p-6">
        <div className="flex items-start space-x-2 sm:space-x-3">
          <AlertCircle className="w-4 h-4 sm:w-6 sm:h-6 text-yellow-600 mt-0.5 flex-shrink-0" />
          <div>
